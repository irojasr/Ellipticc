...
\begin{ptcbp}%Folland 237, 2708452
  ...
  $$|x^\al|\leq C(\al,N)\nm{x}^{\nm{\al}}\leq C(\al,N)\sum_{\nm{\bt}\leq\nm{\al}}|x^\bt|.$$
  También el término $(1+\nm{x})^N$ se puede expandir con el teorema del binomio como 
  $$(1+\nm{x})^N=\sum_{j=0}^N\binom{N}{j}\nm{x}^j\leq\sum_{j=0}^N\binom{N}{j}C(j,N)\sum_{\nm{\bt}\leq j}|x^\bt|.$$
  Ya con esto podemos ver que 
  $$(1+\nm{x})^N|D^\al f(x)|\leq\sum_{j=0}^N\binom{N}{j}C(j,N)\sum_{\nm{\bt}\leq j}|x^\bt D^\al f(x)|\leq\sum_{j=0}^N\binom{N}{j}C(j,N)\sum_{\nm{\bt}\leq j}\sup_{\bR^d}|x^\bt D^\al f(x)|=C(\al,N)$$
  ...
  $$|x^\al D^\bt f(x)|\leq C(\al,N)(1+\nm{x})^{\nm{\al}}|D^\bt f(x)|\leq C(\al,N)\tilde{C}(\bt,\nm{\al}).$$
